...
**[Backstage](https://backstage.spotify.com)**는 *Spotify*에서 개발되어 *CNCF*에서 인큐베이팅되고 있는 프로젝트로 **개발자용 포탈**을 통해 프로젝트를 관리하는 형태를 취하고 있는 플랫폼이라고 스스로를 소개한다.
이 포탈은 개발자들이 다양한 도구와 서비스를 통합하여 보다 일관된 개발 환경을 제공하고, 애플리케이션의 메타데이터를 관리하며, 서비스의 설계/운영 단순화 및 엔지니어링 효율 향상을 도모한다.

[![Backstage 소개 영상](/assets/img/backstage.png)](https://www.youtube.com/embed/85TQEpNCaU0 "Backstage 소개 영상")
